...
# load config {
    source ~/.vimrc.general.config.vim
    source ~/.vimrc.ui.config.vim
    source ~/.vimrc.statusline.config.vim
    source ~/.vimrc.formatting.config.vim
    source ~/.vimrc.keymapping.config.vim
    source ~/.vimrc.gui.config.vim
    source ~/.vimrc.functions.vim
    source ~/.vimrc.plugins.config.vim
# }
